//linked list de aradaan data silme uygulaması ve free(*) kullanımı
/*aradan değer silmeden önce hem silinecek değeri
 *hem de silinen değer sonrasını kaybetmemek çok önemli
 *sonrada silinen değer öncesini sonrasına bağlamak 
 *akabinde silinecek öğeyi silmek gerekli*/
...
node* sil(node *,int);//amacımız int x i linked listden silmek
